...
protocol Alertable: AnyObject {
    func makeAlert(title: String, _ message: String, noCancel: Bool?, closure: @escaping () -> Void )
    static func authAlert()
    func createActionSheet(title: String, actions: [String: Any], closure: @escaping ([String: Any]) -> Void )
}

extension Alertable {
    func makeAlert(title: String = "Alert".localized, _ message: String, noCancel: Bool? = nil, closure: @escaping () -> Void ) {
